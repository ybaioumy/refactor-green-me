...
const NumericInput = ({
  ...
  const decrement = () => {
    handleChange(Math.max((value || 0) - 1, 0));
  };
  ...
  const handleInputChange = (event) => {
    ...
    handleChange(Math.max(0, Math.min(newValue, maxValu)));
  };
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-4">
        <div
          className={`flex items-center justify-around overflow-hidden p-1 rounded-lg bg-white md:w-[300px] w-full ${
